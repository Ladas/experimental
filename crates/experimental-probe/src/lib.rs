...
//!
//! This crate exists so the repository's quality gates have something to chew
...
pub const GREETING: &str = "experimental probe";
...
///
/// ```
/// assert_eq!(experimental_probe::saturating_total(2, 3), 5);
/// ```
#[must_use]
